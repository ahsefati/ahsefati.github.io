var websocketclient = {
    ...
    'connect': function() {
        ...
        this.client = new Messaging.Client("45.82.136.120", 8083, clientId);
    ...
    'render': {
        ...
        'showError': function(message) {
            ...
            if (booo) {
                ...
                errmsg.innerText = "مشکل در اتصال شما به سرور است. اگر از فیلترشکن استفاده میکنید آن را قطع کرده سپس دوباره امتحان نمایید."
            }
        ...
        'message': function(message) {
            ...
            document.getElementById("" + message.topic).innerHTML = message.payload //not ok

            // if (message.topic.includes("temp")) {
            //     var sumOfTemp = 0;
            //     for (var i = 0; i < userSubTopicArray.length; i = i + 3) {
            //         sumOfTemp = sumOfTemp + parseInt(document.getElementById("" + i).innerHTML)
            //     }
            //     var avgTemp = sumOfTemp / (userSubTopicArray.length / 3)
            //     document.getElementById("tTemp1").innerHTML = "میانگین دما : " + avgTemp.toFixed(2) + ' &#x2103;';
            //     document.getElementById("tTemp2").innerHTML = "میانگین دما : " + avgTemp.toFixed(2) + ' &#x2103;';
            // } else if (message.topic.includes("humid")) {

            //     var sumOfHumid = 0;
            //     for (var i = 1; i < userSubTopicArray.length; i = i + 3) {
            //         sumOfHumid = sumOfHumid + parseInt(document.getElementById("" + i).innerHTML)
            //     }
            //     var avgHumid = sumOfHumid / (userSubTopicArray.length / 3)
            //     document.getElementById("tHumid1").innerHTML = "میانگین رطوبت : " + avgHumid.toFixed(2) + "%";
            //     document.getElementById("tHumid2").innerHTML = "میانگین رطوبت : " + avgHumid.toFixed(2) + "%";
            // } else {
            //     var sumOfLight = 0;
            //     for (var i = 2; i < userSubTopicArray.length; i = i + 3) {
            //         sumOfLight = sumOfLight + parseInt(document.getElementById("" + i).innerHTML)
            //     }
            //     var avgLight = sumOfLight / (userSubTopicArray.length / 3)
            //     document.getElementById("tLight1").innerHTML = "میانگین نور : " + avgLight.toFixed(2) + "%";
            //     document.getElementById("tLight2").innerHTML = "میانگین نور : " + avgLight.toFixed(2) + "%";
            // }
